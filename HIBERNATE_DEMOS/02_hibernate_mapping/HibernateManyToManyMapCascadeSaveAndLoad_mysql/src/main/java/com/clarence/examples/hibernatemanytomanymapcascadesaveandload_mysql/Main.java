package com.clarence.examples.hibernatemanytomanymapcascadesaveandload_mysql;
...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        HibernateUtil.setup("create table event_speakers (event_id int, speaker_id int)");
